...
abstract class _$JangkaHidupHewanHighScoreDatabase extends GeneratedDatabase {
  _$JangkaHidupHewanHighScoreDatabase(QueryExecutor e) : super(e);
  $JangkaHidupHewanHighScoreDatabaseManager get managers =>
      $JangkaHidupHewanHighScoreDatabaseManager(this);
...
class $$HighScoresTableFilterComposer
    extends Composer<_$JangkaHidupHewanHighScoreDatabase, $HighScoresTable> {
...
class $$HighScoresTableTableManager extends RootTableManager<
    _$JangkaHidupHewanHighScoreDatabase,
    $HighScoresTable,
    HighScore,
    $$HighScoresTableFilterComposer,
    $$HighScoresTableOrderingComposer,
    ...
    (
      HighScore,
      BaseReferences<_$JangkaHidupHewanHighScoreDatabase, $HighScoresTable,
          HighScore>
    ),
    HighScore,
    PrefetchHooks Function()> {
  $$HighScoresTableTableManager(
      _$JangkaHidupHewanHighScoreDatabase db, $HighScoresTable table)
...
class $JangkaHidupHewanHighScoreDatabaseManager {
  final _$JangkaHidupHewanHighScoreDatabase _db;
  $JangkaHidupHewanHighScoreDatabaseManager(this._db);
