...
LazyDatabase _openConnection() {
  return LazyDatabase(() async {
    ...
    final file = File(p.join(dbFolder.path, 'highscoretinggihewan.sqlite'));
    return NativeDatabase(file);
  });
}

@DriftDatabase(tables: [HighScores])
class TinggiHewanHighScoreDatabase extends _$TinggiHewanHighScoreDatabase {
  TinggiHewanHighScoreDatabase._internal() : super(_openConnection());

  static final TinggiHewanHighScoreDatabase _instance =
      TinggiHewanHighScoreDatabase._internal();

  factory TinggiHewanHighScoreDatabase() => _instance;
